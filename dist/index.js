...
function createStoredObjectsHook(uniqueId, storageFunctions, { cacheMaxAgeSeconds = defaultCacheMaxAgeSeconds } = {}) {
  ...
  function useStoredObjects(filterOrObjectIds) {
    const [objects, setObjects] = import_react.useState(null);
    ...
    const updateWrapper = import_react.useCallback(async (...args) => {
    ...
    const createWrapper = import_react.useCallback(async (...args) => {
    ...
    const deleteWrapper = import_react.useCallback(async (...objs) => {
